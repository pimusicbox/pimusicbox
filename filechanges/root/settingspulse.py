...
#OUTPUT = 'pulsesrc ! decodebin ! audioresample ! audio/x-raw,rate=[48000] ! audio'
#OUTPUT = 'pulsesrc ! decodebin ! audioconvert ! audioresample ! audio rate=[48000]'
