...
copyright = u'2018, Pi MusicBox contributors'
...
htmlhelp_basename = 'PiMusicBoxdoc'
...
latex_documents = [
  (master_doc, 'PiMusicBox.tex', u'Pi MusicBox Documentation',
   u'Pi MusicBox contributors', 'manual'),
]
...
man_pages = [
    (master_doc, 'pimusicbox', u'Pi MusicBox Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'PiMusicBox', u'Pi MusicBox Documentation',
   author, 'PiMusicBox', 'One line description of project.',
   'Miscellaneous'),
]
